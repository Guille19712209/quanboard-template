...
function newVers() {
  const modelName = document.getElementById('d-name-model').value;
  const nameInput = document.getElementById('d-newName-model');
  nameInput.value = modelName;
  nameInput.classList.add("fondo-disabled");
