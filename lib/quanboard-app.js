...
function addTag(value) {
  ...
  function createPicker(pickerId, inputId, defaultColor) {
    ...
    pickr.on('save', (color) => {
      ...
      document.querySelector(inputId).value = rgba;
      pickr.hide();
    });
  ...
  createPicker('#picker-3', '#d-edgesColor-model', 'rgba(100, 100, 100,0.5)');
  createPicker('#picker-4', '#d-objectsColor-model', 'rgba(0, 128, 255, 0.50)');
  createPicker('#picker-5', '#d-borderColor-model', 'rgba(100, 100, 100, 0.50)');
