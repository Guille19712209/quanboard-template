...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const meses = ["Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre",
  ...
  for (let fila = 0; fila < 12; fila++) {
    ...
    th.textContent = `Objeto ${fila + 1}`;
    th.classList.add("fw-bold", "objeto-col");
    tr.appendChild(th);
    ...
    for (let col = 0; col < 12; col++) {
      ...
      input.type = "number";
      input.value = Math.floor(Math.random() * (1000 - 5 + 1)) + 5;
