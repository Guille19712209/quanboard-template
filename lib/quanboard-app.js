...
// TABLA EJEMPLO
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const filaMeses = document.getElementById("fila-meses");
    ...
    for (let i = 1; i <= 12; i++) {
      ...
      th1.textContent = i;
      filaNumeros.appendChild(th1);
      filaNumeros.classList.add("fs-2");

      const th2 = document.createElement("th");
      th2.textContent = meses[i - 1];
      filaMeses.appendChild(th2);
      filaMeses.classList.add("fs-7","fw-light");
    }
    ...
    for (let i = 0; i < 12; i++) {
      ...
      th.textContent = `Objeto ${i + 1}`;
      th.classList.add("fs-6","fw-light");
      tr.appendChild(th);
      
  

      const isDisabled = deshabilitadas.has(i);
