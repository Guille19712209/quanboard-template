...
const cy = cytoscape({
    ...
    elements: [
      { data: { id: 'a', title: 'Title', name: 'Object A', nameSize: "1em", value: '600',valueSize: "2em", unit: '$', unitSize: ".7em", shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 300 } },
      { data: { id: 'b', title: '', name: 'Object B', nameSize: "1em", value: '900',valueSize: "2em", unit: '$', unitSize: ".7em",shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 200 } },
      { data: { id: 'c', title: '', name: 'Object C', nameSize: "1em", value: '30',valueSize: "2em", unit: '$', unitSize: ".7em",shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 100 } },
      { data: { id: 'd', title: '', name: 'Object D', nameSize: "1em", value: '600',valueSize: "2em", unit: '$', unitSize: ".7em", shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 350 } },
      { data: { id: 'e', title: '', name: 'Object E', nameSize: "1em", value: '100',valueSize: "2em", unit: '$', unitSize: ".7em",shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 200 } },
      { data: { id: 'f', title: '', name: 'Object F', nameSize: "1em", value: '350',valueSize: "2em", unit: '$', unitSize: ".7em",shape: 'circle', borderColor: "#000",  nodeColor: "#000",  fontColor: "#000",size: 100 } },
      ...
      tpl: function (data) {
        return `
          <div style="text-align:center; font-family: poppins;">
            ...
            <div style="font-size: ${data.valueSize}; font-weight: bold; color: ${data.fontColor}; line-height: 1;">${data.value}</div>
