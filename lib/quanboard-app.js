...
const cy = cytoscape({
    ...
    elements: [
      { data: { id: 'a', label: 'Nodo A', size: 60 } },
      { data: { id: 'b',  label: 'Nodo B', size: 90 } },
      { data: { id: 'c', label: 'Nodo C',size: 40 } },
...
function addTag(value) {
  ...
  createPicker('#picker-5', '#d-borderColor-model', 'rgba(100, 100, 100, 0.7)');
...
function changeCyTx() {
  ...
  function changeCyBo() {
    const color = document.getElementById('d-borderColor-model').value; 
    cy.nodes().style('color', color);
  }